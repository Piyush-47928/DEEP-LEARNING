...
TensorFlow / Keras (Beginner Level)
...
├── 04_neural_network_basics.py
├── 05_activation_functions.py
├── 06_loss_functions.py
...
3️⃣ Run a File
python 04_neural_network_basics.py
...
Pooling layers explained visually
